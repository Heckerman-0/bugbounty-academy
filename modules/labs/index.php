...
function labLink($slug, $id) {
    ...
    if ($slug == 'owasp-challenge-lab') return 'owasp_lab.php?id=' . (int)$id;
    if ($slug == 'dir-traversal-lab') return 'dir_traversal.php?id=' . (int)$id;
    if ($slug == 'auth-bypass-lab') return 'auth_bypass.php?id=' . (int)$id;
    if ($slug == 'csrf-lab') return 'csrf_lab.php?id=' . (int)$id;
